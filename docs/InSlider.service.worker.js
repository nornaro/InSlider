...
/** @type {string} */
const CACHE_VERSION = '1753458437|141347145187';
/** @type {string} */
const CACHE_PREFIX = 'InSlider-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'InSlider.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["InSlider.html","InSlider.js","InSlider.offline.html","InSlider.icon.png","InSlider.apple-touch-icon.png","InSlider.audio.worklet.js","InSlider.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["InSlider.wasm","InSlider.pck","InSlider.side.wasm"];
